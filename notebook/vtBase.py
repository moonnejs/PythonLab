...
class VtAccountData(VtBaseData):
	...
	self.datetime = None
        ...
        self.Check = False			# 是否通过检查
        

########################################################################
class VtMarginRateData(VtBaseData):
    """保证金比例数据类"""

    #----------------------------------------------------------------------
    def __init__(self):
        """Constructor"""
        super(VtMarginRateData, self).__init__()
        
        # 账号代码相关
        self.vtSymbol = EMPTY_STRING           # 合约代码
        
        # 数值相关
        self.LongMarginRatioByMoney = EMPTY_FLOAT           # 多头保证金率
        self.LongMarginRatioByVolume = EMPTY_FLOAT          # 多头保证金费
        self.ShortMarginRatioByMoney = EMPTY_FLOAT          # 空头保证金率
        self.ShortMarginRatioByVolume = EMPTY_FLOAT         # 空头保证金肥
        self.IsRelative = False				    # 是否相对交易所收取
        self.Check = False				    # 是否通过检查
        

########################################################################
class VtCommissionRateData(VtBaseData):
    """保证金比例数据类"""

    #----------------------------------------------------------------------
    def __init__(self):
        """Constructor"""
        super(VtCommissionRateData, self).__init__()
